...
class AppConfig {
    ...
    senderAppPassword = process.env.APP_PASSWORD;
    resetExpiresMinutes = Number(process.env.RESET_EXPIRES_MINUTES ?? "30");
    resetMailSubject = process.env.RESET_MAIL_SUBJECT ?? "Password reset";
