...
exports.getBreakDownInstructions = getBreakDownInstructions;
...
function getBreakDownInstructions(query, quantity, sugarRestriction, lactoseRestrictions, glutenRestrictions, dietaryRestrictions, caloryRestrictions, queryRestrictions) {
    return `
